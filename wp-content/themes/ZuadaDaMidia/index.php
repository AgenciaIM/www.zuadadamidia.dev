			...
			<div class="col-md-9 col-sm-9 col-xs-12 full-container"> <!--Slide Boxes-->
							...
							<div class="swiper-wrapper">
								<div class="swiper-slide" style="background:url('http://vanimg.s3.amazonaws.com/13-jquery-sliders-9.jpg');background-size:cover;background-position:center center;">
									<div class="swiper-detail">
										<h2><a href="#">Notícia de Destaque 1 Noticia de Destaque 1</a></h2>
									</div>
								  </div>
								...
								<div class="swiper-slide" style="background:url('http://vanimg.s3.amazonaws.com/13-jquery-sliders-7.jpg');background-size:cover;background-position:center center;">
									<div class="swiper-detail">
											<h2><a href="#">Notícia de Destaque 1 Noticia de Destaque 1</a></h2>
										</div>
								  </div>
				...
				<div class="new col-md-4 col-sm-4 col-xs-12 full-container">
					<div class="full-container col-md-12 col-sm-12 col-xs-12">
						<h1><a href="#">O que é Lorem Ipsum O que é Lorem Ipsum?</a></h1>
						<p>
							<a href="#">Lorem Ipsum é simplesmente uma simulação de texto da indústria tipográfica
							e de impressos, e vem sendo uotilizad Ipsum é simplesmente uma si.</a>
						</p>
					</div>
				...
				<div class="col-md-12 col-sm-6 col-xs-12 full-container">
					<div class="col-md-3 col-sm-6 col-xs-12 no-pdl">
						<div class="box col-md-12 col-sm-12 col-xs-12 full-container" style="background:url('http://vanimg.s3.amazonaws.com/13-jquery-sliders-7.jpg') center center;background-size:cover;">
						<h3>Tevê</h3>
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 no-pdl">
						<div class="box col-md-12 col-sm-12 col-xs-12 full-container" style="background:url('http://vanimg.s3.amazonaws.com/13-jquery-sliders-6.jpg') center center;background-size:cover;">
						<h3>Rádio</h3>
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 no-pdl">
						<div class="box col-md-12 col-sm-12 col-xs-12 full-container" style="background:url('http://vanimg.s3.amazonaws.com/13-jquery-sliders-5.jpg') center center;background-size:cover;">
						<h3>Web</h3>
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 no-pdl">
						<div class="box col-md-12 col-sm-12 col-xs-12 full-container" style="background:url('http://vanimg.s3.amazonaws.com/13-jquery-sliders-4.jpg') center center;background-size:cover;">
						<h3>Impresso</h3>
						</div>
					</div>
				</div>
	...
	<div class="container">
		<div class="col-md-10 col-sm-10 col-md-offset-1 col-sm-offset-1">
			...
			<div class="destaque col-md-6 col-sm-6 col-xs-12">
				...
				<div class="col-md-8 col-sm-12 col-xs-12 full-container" style="background:url(http://vanimg.s3.amazonaws.com/13-jquery-sliders-1.jpg) center center;background-size:cover;">
					<div class="col-md-12  col-sm-12 col-xs-12 d1 full-container">
						<div class="d-caption">
							<a href="#">Lorem Ipsum é simplesmente uma simulação 
							de texto da indústria tipográfica e de impressos. 
							</a>
							<p>Lorem Ipsum é simplesmente uma simulação 
							de texto da é simplesmente uma simulação indústria tipográfica e de impressos.</p>
						</div>
					</div>
				...
				<div class="col-md-4 hidden-sm hidden-xs d-2">
					<div class="row">
						<a href="#">
							<div class="d2 col-md-12 col-sm-12 col-xs-12 " style="background:url(http://vanimg.s3.amazonaws.com/13-jquery-sliders-7.jpg) center center;background-size:cover;"></div>
						</a>
						<!--<div class="col-md-7 pdl"><a href="#">Lorem Ipsum é simplesmente uma simulação </a></div>-->
					</div>
					<div class="row">
						<a href="#">
							<div class="d2 col-md-12 col-sm-12 col-xs-12 " style="background:url(http://vanimg.s3.amazonaws.com/13-jquery-sliders-7.jpg) center center;background-size:cover;"></div>
	...
	<div class="container escute">
		<div class="col-md-10  col-sm-10 col-xs-12 col-md-offset-1 col-sm-offset-1">
			<div class="e-box col-md-3 col-sm-4 col-xs-4 no-pdl">
				<div class="escute-box col-md-12 col-sm-12 col-xs-12 full-container" style="background:url(http://vanimg.s3.amazonaws.com/13-jquery-sliders-7.jpg) center center;background-size:cover;">
					<h3>Nacional</h3>
					<div class="col-md-12 col-sm-12 col-xs-12 e-caption">
						<a href="#">Lorem Ipsum é simplesmente uma simulação Ipsum é simplesmente uma simulação Ipsum é</a>
					</div>
					<img class="tri" src="<?php echo get_bloginfo('template_url'); ?>/img/tri-branco.png" />
				</div>
			</div>
			<div class="e-box col-md-3 col-sm-4 col-xs-4 no-pdl">
				<div class="escute-box col-md-12 full-container" style="background:url(http://vanimg.s3.amazonaws.com/13-jquery-sliders-7.jpg) center center;background-size:cover;">
					<h3>Séries</h3>
					<div class="col-md-12 col-sm-12 col-xs-12 e-caption">
						<a href="#">Lorem Ipsum é simplesmente uma simulação Ipsum é simplesmente uma simulação Ipsum é</a>
					</div>
		...
		<div class="col-md-10 col-sm-10 col-xs-12 col-md-offset-1 col-sm-offset-1">
			...
			<div class="col-md-6 col-sm-6 col-xs-8 no-pdl special">
				...
				<div class="col-md-7 col-sm-7 col-xs-6 especial no-pdl">
					<div class="col-md-12 col-sm-12 col-xs-12 esp-img" style="background:url(http://vanimg.s3.amazonaws.com/13-jquery-sliders-7.jpg) center center;background-size:cover;">
						<a href="#" class="mais">+</a>
					</div>
					<a href="#">É simplesmente uma simulação Ipsum é simplesmente </a>
					<p class="hidden-sm hidden-xs">É simplesmente uma simulação Ipsum é simplesmente </p>	
				</div>
				
				<div class="col-md-5 col-sm-5 col-xs-6">
					<div class="row">
						<div class="col-md-6 col-sm-6 col-xs-6 sp-in" style="background:url(http://vanimg.s3.amazonaws.com/13-jquery-sliders-7.jpg) center center;background-size:cover;">
						
						</div>
						<div class="col-md-6 col-sm-6 col-xs-6 no-pdr">
							<a href="#" class="lnk">É simp uma simulação Ipsum é simplesmente </a>
						</div>
					</div>
	...
	<div class="container agencias">
		<div class="col-md-10 col-sm-10 col-xs-12 col-md-offset-1 col-sm-offset-1">
			<div class="col-md-4 col-sm-4 col-xs-16 no-pdl">
				<div class="col-md-12 col-sm-12 col-xs-12 no-pdl agency" style="background:url(http://vanimg.s3.amazonaws.com/13-jquery-sliders-6.jpg) center center;background-size:cover;">
					<h3>Assessoria</h3>
					<div class="oculta"><a href="#">É um fato conhecido A vantagem de usar Lorem Ipsum é que e Conhecido A vantagem de usar Lorem vant...</a></div>
				...
				<h3 class="h3">Acesse</h3>
					<a href="#" class="link">
						<div class="col-md-6 col-sm-6 col-xs-6 no-pdl">
							<div class="col-md-12 col-sm-12 col-xs-12 acesse" style="background:url(http://vanimg.s3.amazonaws.com/13-jquery-sliders-7.jpg) center center;background-size:cover;">
		...
		<div class="col-md-10 col-sm-10 col-xs-12 col-md-offset-1 col-sm-offset-1">
			...
			<div class="col-md-8 col-sm-12 col-xs-12 full-container galeria">
				...
				<div class="col-md-7 col-sm-7 col-xs-7 no-pdl">
					<div class="col-md-12 col-sm-12 col-xs-12 gallery no-pdl" style="background:url(http://vanimg.s3.amazonaws.com/13-jquery-sliders-6.jpg) center center;background-size:cover;">
						<div class="g-caption">
							<a href="#">É um fato conhecido A vantagem de usar Lorem Ipsum é que e...</a>
				...
				<div class="col-md-5 col-sm-5 col-xs-5 full-container">
					<div class="col-md-6 col-sm-6 col-xs-6 no-pdl">
						<div class="col-md-12 col-sm-12 col-xs-12 gallery-in no-pdl" style="background:url(http://vanimg.s3.amazonaws.com/13-jquery-sliders-6.jpg) center center;background-size:cover;">	
							<div class="g-caption-in">
								<a href="#">A vantagem de usar Lorem Ipsum é que e É um fato conhecido A vantagem</a>
							</div>
							<img class="tri" src="<?php echo get_bloginfo('template_url'); ?>/img/tri-branco.png"/>
						</div>	
					</div>

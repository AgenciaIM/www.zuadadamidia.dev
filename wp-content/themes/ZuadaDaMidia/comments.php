	...
	<?php if (!empty($_SERVER['SCRIPT_FILENAME']) && 'comments.php' == basename($_SERVER['SCRIPT_FILENAME']))
			...
			if ( post_password_required() ) { ?>
			  <p class="nocomments">Este artigo está protegido por senha. Faça o login para ver os comentários.</p>
		 <?php
			  return;
		 }
	?>
	 
	<h5><?php comments_number('0 Comentários', '1 Comentário', '% Comentários' );?></h5>
		...
		<div id="respond">
		  ...
		  <?php else : ?>
			  <h6>Comentários desabilitados para esta postagem.</h6>	<?php endif; ?>	  